...
import { Package, Search, Filter, Eye, ArrowUpRight } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-9 space-y-8">
            {/* Search and Filters */}
            <div className="flex flex-col md:flex-row gap-4 bg-white dark:bg-[#111] p-4 rounded-xl border border-gray-100 dark:border-gray-800">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-[#1a1a1a] border border-gray-100 dark:border-gray-800 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-red-500"
                />
              </div>
              <button className="px-4 py-2 border border-gray-100 dark:border-gray-800 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-[#1a1a1a] flex items-center gap-2">
                  ...
                  <div key={order.id} className="border border-gray-100 dark:border-gray-800 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <h4 className="font-bold text-sm uppercase tracking-widest text-gray-500">Items</h4>
                        ...
                        {order.items.slice(0, 3).map((item, index) => (
                          <div key={index} className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="font-bold">{order.currency}{(item.price * item.quantity).toLocaleString()}</p>
                            </div>
                          </div>
                        ))}
