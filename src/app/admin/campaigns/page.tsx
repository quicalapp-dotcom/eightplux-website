        ...
        <div className="space-y-6 bg-white text-black">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-lg border border-gray-200 text-black">
                    <p className="text-xs uppercase tracking-widest text-gray-500 font-bold mb-2">Total Campaigns</p>
                    <p className="text-3xl font-bold text-black">{campaigns.length}</p>
                </div>
                <div className="bg-white p-6 rounded-lg border border-gray-200 text-black">
                    <p className="text-xs uppercase tracking-widest text-gray-500 font-bold mb-2">Active Now</p>
                    <p className="text-3xl font-bold text-green-500">
                        {campaigns.filter(c => c.isActive).length}
                    </p>
                </div>
                <div className="bg-white p-6 rounded-lg border border-gray-200 text-black">
                    <p className="text-xs uppercase tracking-widest text-gray-500 font-bold mb-2">Past Collections</p>
            ...
            {/* Filters and Search */}
            <div className="bg-white p-4 rounded-lg border border-gray-200 flex flex-col md:flex-row gap-4 text-black">
                        ...
                        <div key={campaign.id} className="bg-white rounded-lg border border-gray-200 overflow-hidden group text-black">
                            <div className="aspect-[16/9] relative">
                                ...
                                <div className="absolute top-4 left-4">
                                    <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest ${campaign.isActive
                            ...
                            <div className="p-6">
                                <h3 className="font-bold text-lg mb-2 text-black">{campaign.name}</h3>
