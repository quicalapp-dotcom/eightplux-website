  ...
  return (
    <div className="space-y-4 sm:space-y-6 bg-white text-black">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-black">Catch the Highlights</h1>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-gray-50">
              {loading ? (
                  ...
                  <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-3 sm:px-6 py-3 sm:py-4">
                      <div>
                        ...
                        <div className="text-xs sm:text-sm text-gray-600 truncate max-w-xs">{item.description}</div>
                      </div>
                    </td>
                    <td className="px-3 sm:px-6 py-3 sm:py-4">
                      {editingId === item.id ? (
                ...
                <tr>
                  <td colSpan={4} className="px-3 sm:px-6 py-8 sm:py-12 text-center text-gray-500">No highlights found.</td>
                </tr>
              )}
            </tbody>
          </table>
