        ...
        <div className="space-y-6 bg-white text-black">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-black text-white px-4 py-2 rounded-md text-[10px] font-bold uppercase tracking-widest hover:bg-gray-800 transition-colors shadow-sm"
                >
            ...
            {/* Filters */}
            <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-gray-200 shadow-sm text-black">
                    ...
                    <table className="w-full text-left text-sm">
                        <thead className="bg-gray-50/50 text-gray-500 uppercase tracking-widest text-[10px] font-bold">
                            <tr>
                                ...
                                <th className="px-6 py-5 font-bold">Inventory</th>
                                ...
                                <tr key={product.id} className="hover:bg-gray-50/50 transition-colors">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-14 bg-gray-50 rounded-lg overflow-hidden relative border border-gray-200">
                                                {product.images?.[0] && (
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] text-gray-500 font-mono tracking-tighter">ID: {product.id.slice(0, 8)}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest ${product.inventory > 0
