        ...
        <div className="space-y-6 bg-white text-black">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                    <button className="px-4 py-2 bg-white border border-gray-200 rounded-md text-[10px] font-bold uppercase tracking-widest hover:bg-gray-50 transition-colors shadow-sm text-black">
                        Export Ledger
                    </button>
                </div>
            </div>
            ...
            {/* Filters */}
            <div className="flex flex-col md:flex-row gap-4 bg-white p-4 rounded-xl border border-gray-200 shadow-sm text-black">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left text-sm">
                        <thead className="bg-gray-50/50 text-gray-500 uppercase tracking-widest text-[10px] font-bold">
                            <tr>
                                <th className="px-6 py-5 font-bold">Order Ledger</th>
                                <th className="px-6 py-5 font-bold">Customer Entity</th>
                                <th className="px-6 py-5 font-bold">Timestamp</th>
                                <th className="px-6 py-5 font-bold">Status</th>
                                <th className="px-6 py-5 font-bold">Payment Method</th>
                                <th className="px-6 py-5 font-bold text-right">Settlement</th>
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {filteredOrders.map((order) => (
                                <tr key={order.id} className="hover:bg-gray-50/50 transition-colors">
                                    <td className="px-6 py-4 font-bold font-mono text-[10px] text-gray-500">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[10px] text-gray-500 uppercase font-medium">{order.shippingAddress.city}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            <span className="text-[10px] font-bold uppercase tracking-widest text-gray-600">{order.paymentMethod.replace('_', ' ')}</span>
